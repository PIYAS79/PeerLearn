...
import { GraduationCap, ArrowLeft, Mail, Lock, Cat, Apple } from 'lucide-react';
    ...
    <main className="min-h-screen bg-slate-950 text-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <motion.div 
          ...
          className="glass rounded-[2.5rem] p-8 md:p-10 shadow-2xl border-white/10"
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="glass hover:bg-white/10 py-3 rounded-xl flex items-center justify-center gap-2 transition-all group">
              <Cat className="w-5 h-5 text-slate-300 group-hover:text-white transition-colors" />
              <span className="text-sm font-medium">Google</span>
            </button>
            <button className="glass hover:bg-white/10 py-3 rounded-xl flex items-center justify-center gap-2 transition-all group">
              <Apple className="w-5 h-5 text-slate-300 group-hover:text-white transition-colors" />
